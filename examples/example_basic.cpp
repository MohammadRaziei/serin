...
int main() {
    ...
    std::cout << "------------------------" << std::endl;
    {
        ...
        std::cout << serin::dumpsJson(serin::Value(user), 4) << std::endl;
    }
    std::cout << std::endl;
    ...
    std::cout << "-------------------------" << std::endl;
    {
          ...
          std::cout << serin::dumpsJson(serin::Value(person), 1) << std::endl;
    }
    std::cout << std::endl;
      ...
      std::cout << "--------------------------" << std::endl;
      {
          ...
          std::cout << serin::dumpsJson(serin::Value(tags)) << std::endl;
      }
      std::cout << std::endl;
      ...
      std::cout << "-----------------------" << std::endl;
      {
          ...
          std::cout << serin::dumpsJson(serin::Value(data), 2) << std::endl;
      }
      std::cout << std::endl;
      ...
      std::cout << "-----------------------------" << std::endl;
      {
          ...
          product1["price"] = serin::Value(1200);
...
//          options.delimiter = serin::Delimiter::Tab;
          std::cout << serin::dumpsJson(serin::Value(catalog), 2) << std::endl;
      }
      std::cout << std::endl;
    ...
    //     std::cout << serin::dumpsToon(serin::Value(order)) << std::endl;
    // }
    // std::cout << std::endl;
