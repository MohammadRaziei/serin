...
int main() {
    ...
    std::cout << "------------------------" << std::endl;
    {
        ...
        std::cout << serin::dumpsToon(serin::Value(user)) << std::endl;
    }
    std::cout << std::endl;
     ...
     std::cout << "--------------------------" << std::endl;
     {
         ...
         std::cout << serin::dumpsToon(serin::Value(tags)) << std::endl;
     }
     std::cout << std::endl;
     ...
     std::cout << "-----------------------------" << std::endl;
     {
         ...
         std::cout << serin::dumpsToon(serin::Value(catalog), 2) << std::endl;
     }
     std::cout << std::endl;
